            ...
            {({errors, values, handleChange}) => (
                <Form className="formulario">
                    ...
                    <Field
                        ...
                        value={accountType}
                        style={{width: '50%',  fontFamily: 'Arial, sans-serif', height: '2rem', textAlign: 'center'}}>
                        <option value="">Seleccionar</option>
                        <option value="AHO">AHORROS</option>
                        <option value="CHO">CORRIENTE</option>
                        
                    </Field>

					</div>
                    {/* Conditionally render the Box based on the accountType value */}
                    {accountType && (
                        <Box display="flex" justifyContent="center" my={2}>
                            <Card sx={{minWidth: 300}}>
                                <CardContent>
                                    <Typography variant="h6" gutterBottom>
                                        <span>{accountType}</span><span style={{marginLeft: '6rem'}}>1234567890</span>
                                    </Typography>
                    ...
                    <div style={{marginLeft: '16rem', marginBottom: '10px'}}>
                        ...
                        <Field
                            ...
                            sx={{mb: 2}}
                            style={{marginLeft: '17%', width:'350px'}}
                        />
                    ...
                    <div style={{marginLeft: '16rem', marginBottom: '10px'}}>
                        ...
                        <Field
                            ...
                            sx={{mb: 2}}
                            style={{marginLeft: '16.8%', width:'350px'}}
                        />
                    ...
                    <div style={{marginLeft: '16rem', marginBottom: '10px'}}>
                        ...
                        <Field
                            ...
                            value={values.email}
                            sx={{mb: 2}}
                            style={{marginLeft: '21%', width:'350px'}}
                        />
                    ...
                    <div style={{marginLeft: '16rem', marginBottom: '10px'}}>
                        ...
                        <Field
                            ...
                            value={values.cedula}
                            sx={{mb: 2}}
                            style={{marginLeft: '19.5%', width:'350px'}}
                        />
                    ...
                    <div style={{marginLeft: '16rem', marginBottom: '10px'}}>
                        ...
                        <Field
                            ...
                            value={values.cuenta}
                            sx={{mb: 2}}
                            style={{marginLeft: '7.7%',width:'350px'}}
                        />
